...
const GOOGLE_ERROR_MESSAGES = {
  ...
  token_exchange: "Could not sign in with Google. Please try again.",
  userinfo: "Could not get your profile from Google.",
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (token) {
      localStorage.setItem("leadsathi_token", token);
      setSearchParams({});
      navigate("/home", { replace: true });
      return;
    }
    if (err) {
      setError(GOOGLE_ERROR_MESSAGES[err] || "Something went wrong. Please try again.");
      setSearchParams({});
    }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-1 text-gray-600">Welcome back. Never miss a lead again.</p>
